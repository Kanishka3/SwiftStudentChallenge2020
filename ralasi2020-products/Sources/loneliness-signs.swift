...
public class LonelinessSigns: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        item1.SimplifyItem(text: "Change in sleep cycles")
        item2.SimplifyItem(text:"Laughing all time")
        item3.SimplifyItem(text:"Tired all time")
        item4.SimplifyItem(text: "Feeling empty" )
        ...
        headTitle.LabelSimplified(color: .black, text: "Click the symptoms of loneliness", fontSize: 23, fontWeight: .bold, alignment: .center)
