...
public class DepressionSigns: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        view.addSubviews([headTitle, item3, item4, answerArea])
           ...
           item1.SimplifyItem(text: "Happy all time", backgroundColor: .orange)
           item2.SimplifyItem(text:"Get's angry easily", backgroundColor: .orange)
           item3.SimplifyItem(text:"always hopeless and guilty",  backgroundColor: .orange)
           item4.SimplifyItem(text: "Sad all time",  backgroundColor: .orange)
        ...
        headTitle.LabelSimplified(color: .black, text: "Click the symptoms of depression", fontSize: 23, fontWeight: .bold, alignment: .center)
